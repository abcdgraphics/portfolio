    ...
    >
      <div className='intro-profile'>
        ...
        <div className='social-links'>
          <div className='social-links'>
            <div className='link'>
              <img src='/social-icons/facebook.svg' className='facebook-icon' />
            </div>
            <div className='link'>
              <img src='/social-icons/behance.svg' className='behance-icon' />
            </div>
            <div className='link'>
              <img src='/social-icons/linkedin.svg' className='linkedin-icon' />
            </div>
            <div className='link'>
              <img
...
function Projects({ elementsRef }) {
  useEffect(() => {
    const handleScroll = () => {
      const heading = document.querySelector('.projets-main-heading');
      if (heading) {
        const sticky = heading.getBoundingClientRect().top === 0;
        heading.classList.toggle('sticky', sticky);
      }
    };
