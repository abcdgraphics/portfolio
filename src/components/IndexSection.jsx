  ...
  return (
    <div
      ...
      <div className="index">
        ...
        <Card title="WEB" icon="/index-icons/web.svg" link="#web">
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-black"
            colors={[
        ...
        <Card title="SOCIAL" icon="/index-icons/social.svg" link="#social">
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-black"
            colors={[
        ...
        <Card title="PRINT" icon="/index-icons/print.svg" link="#print">
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-black"
            colors={[
        ...
        <Card title="BRAND" icon="/index-icons/brand.svg" link="#brand">
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-black"
            colors={[
        ...
        <Card title="EXTRA" icon="/index-icons/extra.svg" link="#extra">
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-black"
            colors={[
        ...
        <Card title="CONTACT" icon="/index-icons/contact.svg" link="#contact">
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-black"
            colors={[
