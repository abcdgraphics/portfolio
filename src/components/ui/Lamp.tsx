    ...
    return (
        <LampContainer>
            <motion.h1
                ...
                className="mt-8 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-[30px] font-medium tracking-tight text-transparent md:text-[30px]"
            >
                It has survived not only five centuries, <br />but also the leap into electronic typesetting, <br /> remaining essentially unchanged.
            </motion.h1>
        </LampContainer>
    );
}
...
export const LampContainer = ({
    ...
    return (
        <div
            className={cn(
                "relative flex h-[100vh] flex-col items-center justify-center overflow-hidden bg-white w-full rounded-md mt-[-100px] z-[-1]",
                className
            )}
        >
